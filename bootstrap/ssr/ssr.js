...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.vue`,
      /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-zRgG1QCu.js"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-DS9j5bcj.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-BOyPYkz1.js"), "./Pages/Auth/Register.vue": () => import("./assets/Register-DxI7PjBG.js"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-B0oEaBba.js"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-BtSnXDzE.js"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard-CWhR9f4i.js"), "./Pages/FileUpload.vue": () => import("./assets/FileUpload-dfNGofws.js"), "./Pages/HexTable.vue": () => import("./assets/HexTable-BbpLA4Lx.js"), "./Pages/Home.vue": () => import("./assets/Home-BlqTBA8J.js"), "./Pages/MyFiles.vue": () => import("./assets/MyFiles-o0EooLiM.js"), "./Pages/Profile/Edit.vue": () => import("./assets/Edit-QBrmQLYV.js"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-DKuPgsN7.js"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-BxySfw41.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-CUtN6tYX.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-DMaBece4.js") })
    ),
