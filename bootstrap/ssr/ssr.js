...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.vue`,
      /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword--n2QtmgJ.js"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-DfEXEnJE.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-A-Jtypia.js"), "./Pages/Auth/Register.vue": () => import("./assets/Register-BfBEWpRn.js"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-F4CgxNI3.js"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-BtSnXDzE.js"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard-Co6HH6vB.js"), "./Pages/FileUpload.vue": () => import("./assets/FileUpload-IZqog20C.js"), "./Pages/HexTable.vue": () => import("./assets/HexTable-BqmhMqYx.js"), "./Pages/Home.vue": () => import("./assets/Home-BSl4Ftra.js"), "./Pages/MyFiles.vue": () => import("./assets/MyFiles-BpaxtbGm.js"), "./Pages/Profile/Edit.vue": () => import("./assets/Edit-CATiqDC0.js"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-DrswXCa_.js"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-9wPlcJov.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-0HMAXwKh.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-DMaBece4.js") })
    ),
