...
import { _ as _sfc_main$6 } from "./InputError-D7Pvlg8p.js";
import { _ as _sfc_main$4, a as _sfc_main$5 } from "./TextInput-C_DOY57T.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "space-y-6" }, _attrs))}><header><h2 class="text-lg font-medium">Delete Account</h2></header>`);
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-6"${_scopeId}><h2 class="text-lg font-medium"${_scopeId}> Are you sure you want to delete your account? </h2><p class="mt-1 text-sm"${_scopeId}> Once your account is deleted, all of its resources and data will be permanently deleted. Please enter your password to confirm you would like to permanently delete your account. </p><div class="mt-6"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "p-6" }, [
                createVNode("h2", { class: "text-lg font-medium" }, " Are you sure you want to delete your account? "),
                createVNode("p", { class: "mt-1 text-sm" }, " Once your account is deleted, all of its resources and data will be permanently deleted. Please enter your password to confirm you would like to permanently delete your account. "),
