    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex justify-center"${_scopeId}><div class="mx-64 mt-20 min-w-96 rounded-xl p-4"${_scopeId}><h1 class="text-center text-3xl font-extrabold"${_scopeId}>Register</h1><form${_scopeId}><div${_scopeId}>`);
